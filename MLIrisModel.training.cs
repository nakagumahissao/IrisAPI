...
namespace IrisAPI
{
    public partial class MLIrisModel
    {
        public const string RetrainFilePath =  @"C:\Users\nakag_l8pjkkk\Documents\Projects\IrisAPI\irisExcel.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"Sepal Length", @"Sepal Length"),new InputOutputColumnPair(@"Sepal Width", @"Sepal Width"),new InputOutputColumnPair(@"Petal Length", @"Petal Length"),new InputOutputColumnPair(@"Petal Width", @"Petal Width")})      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=1.0198216F,L2Regularization=0.9862144F,LabelColumnName=@"class",FeatureColumnName=@"Features"}))      
